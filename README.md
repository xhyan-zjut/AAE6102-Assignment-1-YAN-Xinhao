...
Then, we need to set the intermediate frequency (IF) and sampling frequency. 
Note that the original signal is GPS L1 signal, and the IF is 4.58 MHz, sampling frequency is 58 MHz, thus we set the above parameters in initSettings.m as follows:
